from jaqsd.kline.framework import DailyTaskExecutor, KlineStorage, BarTaskExecutor
from jaqsd.kline.mongodb import MongoDBTask, MongoDBDaily, MongoDBBar
import click


def init_executor():
    return DailyTaskExecutor(MongoDBTask.init_from_env(), MongoDBDaily.init_from_env())
